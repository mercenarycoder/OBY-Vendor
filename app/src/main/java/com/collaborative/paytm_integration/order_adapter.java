...
public class order_adapter  extends RecyclerView.Adapter<order_adapter.viewholder1>{
    ...
    public viewholder1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflator=LayoutInflater.from(context).inflate(R.layout.order_item_see, parent,
                false);
    ...
    public static class viewholder1 extends RecyclerView.ViewHolder
    {
       TextView quantity,product_name,amount;
        public viewholder1(@NonNull View itemView) {
            super(itemView);
           quantity=(TextView)itemView.findViewById(R.id.no_units);
           product_name=(TextView)itemView.findViewById(R.id.no_product_name);
           amount=(TextView)itemView.findViewById(R.id.no_amount);
        }
    }
}
